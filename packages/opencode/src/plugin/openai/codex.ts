...
<html>
  <head>
    <title>Open Code Neo - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Open Code Neo.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>Open Code Neo - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
