...
const TIPS: Tip[] = [
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.opencode-neo/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.opencode-neo/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.opencode-neo/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.opencode-neo/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent OpenCode from reading sensitive files",
  "Use {highlight}ocn run{/highlight} for non-interactive scripting",
  "Use {highlight}ocn --continue{/highlight} to resume the last session",
  "Use {highlight}ocn run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ocn serve{/highlight} for headless API access to OpenCode",
  "Use {highlight}ocn run --attach{/highlight} to connect to a running server",
  "Run {highlight}ocn upgrade{/highlight} to update to the latest version",
  "Run {highlight}ocn auth list{/highlight} to see all configured providers",
  "Run {highlight}ocn agent create{/highlight} for guided agent creation",
  "Use {highlight}/ocn{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}ocn github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/opencode fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.opencode-neo/themes/{/highlight} directory",
  ...
  "Run {highlight}ocn debug config{/highlight} to troubleshoot configuration",
