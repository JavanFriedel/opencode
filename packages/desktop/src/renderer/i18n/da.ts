export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Open Code Neo er blevet downloadet. Vil du installere den og genstarte?",
