export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Open Code Neo-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Open Code Neo-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
