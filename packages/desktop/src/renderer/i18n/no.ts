export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Open Code Neo er lastet ned. Vil du installere den og starte på nytt?",
