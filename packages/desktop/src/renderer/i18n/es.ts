export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Open Code Neo. ¿Quieres instalarla y reiniciar?",
