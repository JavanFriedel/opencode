export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Open Code Neo wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
