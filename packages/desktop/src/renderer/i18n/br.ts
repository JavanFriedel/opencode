export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Open Code Neo foi baixada. Você gostaria de instalá-la e reiniciar?",
