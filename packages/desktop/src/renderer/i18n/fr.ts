export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Open Code Neo a été téléchargée. Voulez-vous l'installer et redémarrer ?",
