export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} Open Code Neo завантажено. Бажаєте встановити її та перезапустити?",
