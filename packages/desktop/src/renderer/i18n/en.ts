export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Open Code Neo has been downloaded, would you like to install it and relaunch?",
