export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Open Code Neo. Czy chcesz ją zainstalować i uruchomić ponownie?",
