export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Open Code Neo",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Open Code Neo، هل ترغب في تثبيته وإعادة تشغيله؟",
